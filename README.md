...
| --- | --- | --- |
| [restart-sessions](.agents/skills/restart-sessions/README.md) | [Herdr](https://herdr.dev) 上のセッションを、会話ログを引き継いで再起動する。このリポジトリで起動すると、コンテキストの使用率を見張り、知らせの出たセッションを確認なしで再起動する | Herdr。実機確認は macOS・Windows 11 |
